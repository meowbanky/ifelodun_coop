      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-lg rounded-lg p-8 mb-8 transform transition-all hover:scale-105 hover:shadow-xl">
          ...
          <p className="text-gray-600 mb-6">
            To promote the economic wellbeing of our members through sustainable
            cooperative practices, providing accessible financial services, and
            fostering a culture of saving and mutual support within the OOUTH
            community.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            To be the leading healthcare cooperative society in Ogun State,
            exemplifying excellence in member service, financial stability, and
            community impact.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-lg rounded-lg p-8 transform transition-all hover:scale-105 hover:shadow-xl">
            ...
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-center">
                <span className="mr-2">•</span> Access to affordable credit
                facilities
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                <span className="mr-2">•</span> Financial security through
                mutual support
              </li>
              <li className="flex items-center">
                <span className="mr-2">•</span> Regular financial education
                workshops
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                <span className="mr-2">•</span> Access to special welfare
                packages
              </li>
            </ul>
          </div>
